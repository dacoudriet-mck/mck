 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    rg_name = 'rg-ecoaog7wk6-5'\n",
    "\n",
    "# The data factory name. It must be globally unique.\n",
    "    df_name = 'dfecoaog7'\n",
    "\n",
    "# Specify your Active Directory client ID, client secret, and tenant ID\n",
    "    credentials = ServicePrincipalCredentials(client_id='de43ad06-6036-4e14-8dfa-102ef89d2516', secret='LW7G+iGeDQPWOidM8bFqIncz9c5vZOzNDHpIuwGxJoc=', tenant='da67ef1b-ca59-4db2-9a8c-aa8d94617a16')\n",
    ...
    "    storage_string = SecureString('DefaultEndpointsProtocol=https;AccountName=saecoaog7wk60101;AccountKey=8GAje9/SCT8BfcF+itj0mq4aEDYdzque1NuKn46o4eA5i16oL4T1LMYmJS0lwxisODCKVMswjp1yBghzvBBu0Q==')\n",
    "\n",
