...
items = table_service.query_entities('itemstable', filter="PartitionKey eq 'carsmenu'", select='description,price')
for item in items:
    print('Name: ' + item.description)
    print('Price: ' + str(item.price) + '\n')

items = table_service.query_entities('itemstable', filter="PartitionKey eq 'coffeestore'", select='description,cost')
for item in items:
    print('Name: ' + item.description)
